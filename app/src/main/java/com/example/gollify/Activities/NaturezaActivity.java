...
import com.example.gollify.Fragments.NaturezaFragment1;
import com.example.gollify.Fragments.NaturezaFragment2;
import com.example.gollify.Fragments.NaturezaFragment3;
import com.example.gollify.Fragments.NaturezaFragment4;
import com.example.gollify.R;

public class NaturezaActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            NaturezaFragment1 fragment1 = new NaturezaFragment1();
        ...
        btnProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cont > 4){
                    ...
                    FragmentTransaction ft = fm.beginTransaction();
                    NaturezaFragment2 fragment2 = (NaturezaFragment2) fm.findFragmentByTag("fragment2");
                    if(fragment2 == null) {
                        fragment2 = new NaturezaFragment2();
                    ...
                    Toast.makeText(getApplication(), " CONT: " + cont, Toast.LENGTH_SHORT).show();
                    FragmentTransaction ft = fm.beginTransaction();
                    NaturezaFragment3 fragment3 = (NaturezaFragment3) fm.findFragmentByTag("fragment3");
                    if (fragment3 == null) {
                        fragment3 = new NaturezaFragment3();
                    ...
                    Toast.makeText(getApplication(), " CONT: " + cont, Toast.LENGTH_SHORT).show();
                    FragmentTransaction ft = fm.beginTransaction();
                    NaturezaFragment4 fragment4 = (NaturezaFragment4) fm.findFragmentByTag("fragment4");
                    if (fragment4 == null) {
                        fragment4 = new NaturezaFragment4();
            ...
            public void onClick(View v) {
               ...
               if(cont < 0){
                   cont = 1;
                    ...
                    Toast.makeText(getApplication(), " CONT: "+cont, Toast.LENGTH_SHORT).show();
                    FragmentTransaction ft = fm.beginTransaction();
                    NaturezaFragment1 fragment1 = (NaturezaFragment1) fm.findFragmentByTag("fragment1");
                    if(fragment1 == null) {
                        fragment1 = new NaturezaFragment1();
