 ...
 */
public class AmizadeFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.amizade_fragment3, container, false);
        ...
        btnLister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(getContext(), R.raw.our_boss);
                playMusic();
            }
        });
    ...
    public void gravarMoedas() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                boolean isInserted = myDatabase.inserirDadosMoedas("1600");
                if (isInserted == true) {
                ...
                boolean isUpdate = myDatabase.atualizarMoedas(id, "1600");
                if (isUpdate == true) {
    ...
    public void salvarArquivo(String pontos) {
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(nome.concat("_act6C"), Context.MODE_PRIVATE);
