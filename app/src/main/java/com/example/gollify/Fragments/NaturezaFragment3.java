 ...
 */
public class NaturezaFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.natureza_fragment3, container, false);
    ...
    public void validarResposta(){
      //  rbAlternativa1.setBackgroundResource(R.drawable.retangle_button);
        ...
        rbAlternativa3.setCompoundDrawables(null,null,acertou,null);
    ...
    public void gravarMoedas() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                // Tabela esta vazia, preencha com seus dados iniciais
                boolean isInserted = myDatabase.inserirDadosMoedas("2000");
                if (isInserted == true) {
                    Toast.makeText(getContext(), "Dados inseridos", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getContext(), "Dados não podem ser inseridos", Toast.LENGTH_LONG).show();
                ...
                // Tabela ja contem dados.
                boolean isUpdate = myDatabase.atualizarMoedas(id, "2000");
                if (isUpdate == true) {
    ...
    public void salvarArquivo(String pontos) {
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(nome.concat("_act8C"), Context.MODE_PRIVATE);
