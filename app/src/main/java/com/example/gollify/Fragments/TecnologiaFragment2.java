 ...
 */
public class TecnologiaFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.tecnologia_fragment2, container, false);
    ...
    public void gravarMoedas() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                // Tabela esta vazia, preencha com seus dados iniciais
                boolean isInserted = myDatabase.inserirDadosMoedas("2300");
                if (isInserted == true) {
                    Toast.makeText(getContext(), "Dados inseridos", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getContext(), "Dados não podem ser inseridos", Toast.LENGTH_LONG).show();
                ...
                // Tabela ja contem dados.
                boolean isUpdate = myDatabase.atualizarMoedas(id, "2300");
                if (isUpdate == true) {
    ...
    public void salvarArquivo(String pontos) {
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(nome.concat("_act9B"), Context.MODE_PRIVATE);
