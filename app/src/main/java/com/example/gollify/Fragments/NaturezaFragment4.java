 ...
 */
public class NaturezaFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.natureza_fragment4, container, false);
        ...
        responderQuestoes = view.findViewById(R.id.rgQuestoes);
        ...
        responderQuestoes.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {

                switch (responderQuestoes.getCheckedRadioButtonId()) {
              ...
              //  Toast.makeText(getContext(), responderQuestoes.getCheckedRadioButtonId()+" | "+ R.id.rbAlternativa1, Toast.LENGTH_LONG).show();
    ...
    public void validarResposta(){
      //  rbAlternativa1.setBackgroundResource(R.drawable.retangle_button);
        ...
        rbAlternativa1.setCompoundDrawables(null,null,errou,null);
        rbAlternativa2.setCompoundDrawables(null,null,acertou,null);
    ...
    public void gravarMoedas() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                // Tabela esta vazia, preencha com seus dados iniciais
                boolean isInserted = myDatabase.inserirDadosMoedas("2100");
                if (isInserted == true) {
                    Toast.makeText(getContext(), "Dados inseridos", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getContext(), "Dados não podem ser inseridos", Toast.LENGTH_LONG).show();
                ...
                // Tabela ja contem dados.
                boolean isUpdate = myDatabase.atualizarMoedas(id, "2100");
                if (isUpdate == true) {
    ...
    public void gravarProgresso() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                // Tabela esta vazia, preencha com seus dados iniciais
                boolean isInserted = myDatabase.inserirDadosProgesso("80");
                if (isInserted == true) {
                    Toast.makeText(getContext(), "Dados inseridos", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getContext(), "Dados não podem ser inseridos", Toast.LENGTH_LONG).show();
                ...
                // Tabela ja contem dados.
                boolean isUpdate = myDatabase.atualizarProgresso(id, "80");
                if (isUpdate == true) {
                    //Toast.makeText(this, "Dados atualizados", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getContext(), "Dados não podem ser atualizados", Toast.LENGTH_LONG).show();
    ...
    public void gravarStatusCardViews() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                // Tabela esta vazia, preencha com seus dados iniciais
                boolean isInserted = myDatabase.inserirDadosCardViews("9");
                if (isInserted == true) {
                ...
                // Tabela ja contem dados.
                boolean isUpdate = myDatabase.atualizarCardViews(id, "9");
                if (isUpdate == true) {
                    //Toast.makeText(this, "Dados atualizados", Toast.LENGTH_LONG).show();
                } else {
    ...
    public void salvarArquivo(String pontos) {
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(nome.concat("_act8D"), Context.MODE_PRIVATE);
