 ...
 */
public class CotidianoFragment4 extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            Log.i("Tela Fragment4: ", id);
            Log.i("Tela Fragment4: ", nome);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.cotidiano_fragment4, container, false);
        ...
        btnLister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(getContext(), R.raw.like_eat);
                playMusic();
    ...
    public void inicializaVetores(){
        ...
        for (int cont = 0; cont < 1; cont++) {
            ...
            Log.i("Foi clicado Fragment4: " + cont + " |", String.valueOf(foiClicado[cont]));
    ...
    public void gravarMoedas() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                // Tabela esta vazia, preencha com seus dados iniciais
                boolean isInserted = myDatabase.inserirDadosMoedas("1300");
                if (isInserted == true) {
                    Toast.makeText(getContext(), "Dados inseridos", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getContext(), "Dados não podem ser inseridos", Toast.LENGTH_LONG).show();
                ...
                // Tabela ja contem dados.
                boolean isUpdate = myDatabase.atualizarMoedas(id, "1300");
                if (isUpdate == true) {
    ...
    public void gravarProgresso() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                // Tabela esta vazia, preencha com seus dados iniciais
                boolean isInserted = myDatabase.inserirDadosProgesso("50");
                if (isInserted == true) {
                   // Toast.makeText(getContext(), "Dados inseridos", Toast.LENGTH_LONG).show();
                } else {
                   // Toast.makeText(getContext(), "Dados não podem ser inseridos", Toast.LENGTH_LONG).show();
                ...
                // Tabela ja contem dados.
                boolean isUpdate = myDatabase.atualizarProgresso(id, "50");
                if (isUpdate == true) {
                    //Toast.makeText(this, "Dados atualizados", Toast.LENGTH_LONG).show();
                } else {
                    //Toast.makeText(getContext(), "Dados não podem ser atualizados", Toast.LENGTH_LONG).show();
    ...
    public void gravarStatusCardViews() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                // Tabela esta vazia, preencha com seus dados iniciais
                boolean isInserted = myDatabase.inserirDadosCardViews("6");
                if (isInserted == true) {
                ...
                // Tabela ja contem dados.
                boolean isUpdate = myDatabase.atualizarCardViews(id, "6");
                if (isUpdate == true) {
                    //Toast.makeText(this, "Dados atualizados", Toast.LENGTH_LONG).show();
                } else {
    ...
    public void salvarArquivo(String pontos) {
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(nome.concat("_act5D"), Context.MODE_PRIVATE);
