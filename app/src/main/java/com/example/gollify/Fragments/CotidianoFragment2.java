 ...
 */
public class CotidianoFragment2 extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            Log.i("Tela Fragment2: ", id);
            Log.i("Tela Fragment2: ", nome);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.cotidiano_fragment2, container, false);
        ...
        btnLister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(getContext(), R.raw.how_are);
                playMusic();
    ...
    public void inicializaVetores(){
        ...
        for (int cont = 0; cont < 1; cont++) {
            ...
            Log.i("Foi clicado Fragment2: " + cont + " |", String.valueOf(foiClicado[cont]));
    ...
    public void gravarMoedas() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                // Tabela esta vazia, preencha com seus dados iniciais
                boolean isInserted = myDatabase.inserirDadosMoedas("1100");
                if (isInserted == true) {
                    Toast.makeText(getContext(), "Dados inseridos", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getContext(), "Dados não podem ser inseridos", Toast.LENGTH_LONG).show();
                ...
                // Tabela ja contem dados.
                boolean isUpdate = myDatabase.atualizarMoedas(id, "1100");
                if (isUpdate == true) {
    ...
    public void salvarArquivo(String pontos) {
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(nome.concat("_act5B"), Context.MODE_PRIVATE);
