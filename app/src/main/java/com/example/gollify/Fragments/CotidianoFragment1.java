 ...
 */
public class CotidianoFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.cotidiano_fragment1, container, false);

        txvResult = view.findViewById(R.id.txvResult);
        questions = view.findViewById(R.id.questions);
        falarPronuncia = view.findViewById(R.id.btnSpeak);
        ...
        falarPronuncia.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnLister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(getContext(), R.raw.good_morning);
                playMusic();
            }
        });
   ...
   public void ouvirPronuncia(){
    ...
    public void gravarMoedas() {
        ...
        if (cur != null) {
            ...
            if (cur.getInt(0) == 0) {
                ...
                // Tabela esta vazia, preencha com seus dados iniciais
                boolean isInserted = myDatabase.inserirDadosMoedas("1000");
                if (isInserted == true) {
                    Toast.makeText(getContext(), "Dados inseridos", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getContext(), "Dados não podem ser inseridos", Toast.LENGTH_LONG).show();
                ...
                // Tabela ja contem dados.
                boolean isUpdate = myDatabase.atualizarMoedas(id, "1000");
                if (isUpdate == true) {
    ...
    public void salvarArquivo(String pontos) {
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(nome.concat("_act5A"), Context.MODE_PRIVATE);
